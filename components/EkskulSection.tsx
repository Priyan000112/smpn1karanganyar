    ...
    <section className="py-12 md:py-16 bg-white dark:bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
          {preview.map((ekskul) => (
            <div key={ekskul.nama} className="card p-4 md:p-5 text-center hover:border-primary-200 dark:hover:border-primary-800 border border-transparent transition-all group">
              ...
              <p className="text-2xs text-primary-600 dark:text-primary-400 mt-2 font-medium font-roboto hidden sm:block">
                {ekskul.pembina}
              </p>
            </div>
          ))}

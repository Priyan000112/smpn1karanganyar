    ...
    <section className="py-12 md:py-16 bg-primary-700 dark:bg-primary-900 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4">
          {fasilitasList.map((f) => (
            <div key={f.nama} className="bg-white/10 hover:bg-white/20 backdrop-blur rounded-xl md:rounded-2xl p-4 md:p-5 transition-colors border border-white/10 hover:border-white/20">
